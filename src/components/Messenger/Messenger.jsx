...
function Messenger({ messages, users, changeMessengerInput, addMessage }) {
  ...
  function sendMessage() {
    ...
    addMessage(id, messages.input.text);
  }
    ...
    <section className="grid sm:grid-cols-[200px_1fr]">
      ...
      <div className="bg-gray-100 p-4">
        ...
        <div className="flex gap-2 my-4">
          <input ref={newMessageText} onChange={stateText} className="border border-gray-300 p-2" type="text" value={messages.input.text} />
